    ...
    public static void main(String[] args) throws IOException, TimeoutException {
        ...
        try{
           ...
           //创建会话通道
            ...
            channel.queueBind(QUEUE_INFORM_EMAIL,EXCHANGE_HEADERS_INFORM,"");
            channel.queueBind(QUEUE_INFORM_SMS,EXCHANGE_HEADERS_INFORM,"");
            //发送消息
            ...
            channel.basicPublish(EXCHANGE_HEADERS_INFORM,"",properties.build(),content.getBytes());
            System.out.println("send:通知");
        }catch (Exception e){
